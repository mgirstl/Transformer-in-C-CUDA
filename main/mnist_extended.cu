/**
 * @file mnist_extended.cu
 * @brief This file executes the MNIST_Extended training and evaluation.
 */

#include <iostream>

#include "../src/core.cuh"
#include "../src/models/mnist_extended.cuh"
#include "../src/optimizers.cuh"
#include "../src/utils/config.cuh"

/**
 * @brief Main function to train the MNIST_Extended model.
 *
